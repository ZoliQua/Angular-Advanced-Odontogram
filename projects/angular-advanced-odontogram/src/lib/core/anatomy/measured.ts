...
// Angular port deviation: the ?raw imports become a dedicated generated
// module (`generated/teeth-svgs-measured.ts`, kept SEPARATE from the classic
// `generated/teeth-svgs.ts`) so the code-split boundary this file documents
// above survives ng-packagr/Vitest — merging it into the classic (eager)
// generated module would silently pull the ~1.1 MB measured artwork back
// into the main chunk. See scripts/generate-svg-assets.mjs.
import {
