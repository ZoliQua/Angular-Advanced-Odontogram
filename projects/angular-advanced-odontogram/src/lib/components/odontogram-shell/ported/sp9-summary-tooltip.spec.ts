// Angular port of core/__tests__/sp9-summary-tooltip.test.ts. Framework-free
...
import { getToothStateSummary, __setToothStateForTest, setPulpDetailLevel } from "../../../core/odontogram";
