// Angular port of core/__tests__/restoration-summary.test.ts. Framework-free
// (swept into REACT_DEPENDENT by the exclusion grep's "useI18n" keyword match
// only) — verbatim port, import paths adjusted for
// components/odontogram-shell/ported/.
import { describe, it, expect, beforeEach } from "vitest";
import { __setToothStateForTest, getToothStateSummary, getOdontogramSummary } from "../../../core/odontogram";
