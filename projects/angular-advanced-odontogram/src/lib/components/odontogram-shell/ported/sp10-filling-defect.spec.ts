// Angular port of core/__tests__/sp10-filling-defect.test.ts. Framework-free
...
import { __setToothStateForTest, __getToothStateForTest, __collectExportPayloadForTest, VALID_FILLING_DEFECT, applyFillingDefect } from "../../../core/odontogram";
