...
- 🌍 National coding packs (Settings → General → Diagnosis coding pack): overlay a national code system on the WHO ICD-10 base — BNO-10 (Hungarian, official NEAK titles; keeps the WHO code) or US ICD-10-CM (remapped codes, e.g. the K07 dentofacial range → M26)
